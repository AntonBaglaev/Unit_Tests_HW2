...
*/
    ...
    void whenChangingCartCostRecalculationIsCalled() {
        ...
        cart.addProductToCartByID(2); // 170 = 870
...
//        assertThat(cart.cartItems.get(0).getQuantity()).isEqualTo(6);
//        assertThat(shop.getProductsShop().get(0).getQuantity()).isEqualTo(4);
        cart.removeProductByID(1);
        cart.removeProductByID(1);
        cart.removeProductByID(1); // корзина - 3б магазин - 7
        // Assert
    ...
    void incorrectProductRemoveCausesException() {
        ...
        // Assert
        String exceptedMessage = "В корзине не найден продукт с id: " + id;
        String actualMessage = exception.getMessage();
